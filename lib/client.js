...
.drv-ctx-line { background:transparent; }
.drv-gutter { color:#57606a; }
...
@media (prefers-color-scheme: dark) {
  ...
  .drv-add { background:#10251c; color:#7ee787; }
  .drv-del { background:#2d1415; color:#ffa198; }
  .drv-gutter { color:#8b949e; }
  .drv-turn-add { color:#7ee787; }
  .drv-turn-del { color:#ffa198; }
}
...
.dsw-dark .drv-add,
:root[data-theme="dark"] .drv-add { background:#10251c; color:#7ee787; }
.dsw-dark .drv-del,
:root[data-theme="dark"] .drv-del { background:#2d1415; color:#ffa198; }
.dsw-dark .drv-gutter,
:root[data-theme="dark"] .drv-gutter { color:#8b949e; }
.dsw-dark .drv-turn-add,
:root[data-theme="dark"] .drv-turn-add { color:#7ee787; }
.dsw-dark .drv-turn-del,
:root[data-theme="dark"] .drv-turn-del { color:#ffa198; }
`;
		function apply(ctx) {
			ctxRef = ctx;
			ctx.effect(() => {
